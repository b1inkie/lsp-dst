...
---EntityScript: 将数值限制在指定的范围内。(非标准库)
...
---EntityScript: 圆周率 π 的值。
---@return number # 圆周率 π 的值
---author: lan
function math:pi()
end

---EntityScript: 计算双曲正弦值。
---@param x number # 数值
---@return number # 双曲正弦值
---author: lan
...
---EntityScript: 将数字表示为 x * 2^n 的形式，返回 x 和 n。
...
---EntityScript: 返回两个数的差值的绝对值(非标准库)
---@param a number # 
---@param b number # 
