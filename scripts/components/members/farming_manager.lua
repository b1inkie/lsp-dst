...
---@class component_farming_manager: component_base
---@field inst idk
...
function farming_manager:WatchWorldState(var, fn) end

---@param var string
---@param fn fun(inst: ent, ...):any
function farming_manager:StopWatchingWorldState(var, fn) end
