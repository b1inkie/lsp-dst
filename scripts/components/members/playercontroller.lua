...
---@class component_playercontroller: component_base
...
function playercontroller:WatchWorldState(var, fn) end

---@param var string
---@param fn fun(inst: ent, ...):any
function playercontroller:StopWatchingWorldState(var, fn) end
