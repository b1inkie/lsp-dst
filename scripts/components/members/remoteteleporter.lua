...
---@class component_remoteteleporter: component_base
---@field inst idk
...
function remoteteleporter:WatchWorldState(var, fn) end

---@param var string
---@param fn fun(inst: ent, ...):any
function remoteteleporter:StopWatchingWorldState(var, fn) end
