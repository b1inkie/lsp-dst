...
---@class component_roseinspectableuser: component_base
---@field inst idk
...
function roseinspectableuser:WatchWorldState(var, fn) end

---@param var string
---@param fn fun(inst: ent, ...):any
function roseinspectableuser:StopWatchingWorldState(var, fn) end
