...
---@class component_stageactingprop: component_base
---@field inst idk
---@field cast idk
---@field script idk
...
function stageactingprop:WatchWorldState(var, fn) end

---@param var string
---@param fn fun(inst: ent, ...):any
function stageactingprop:StopWatchingWorldState(var, fn) end
